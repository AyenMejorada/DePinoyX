  ...
  return (
    <button
      className={cn(
        ...
        // "Play Now" variant
        variant === "play" &&
          "bg-[#E3E3E3] text-black hover:bg-[#FF9311] hover:text-white",

        // Bet variant
        variant === "bet" &&
          `border-2 border-[#FF9311] text-[#FF9311] bg-transparent 
          hover:bg-[#FF9311] hover:text-[#121212]
          ${selected ? "bg-[#FF9311] text-[#121212]" : ""}`,

        // Color variant
        variant === "color" &&
          `w-[100px] h-[100px] ${colorClass} text-black 
          transition-all transform hover:brightness-90
